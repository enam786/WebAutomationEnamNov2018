...
public class GoogleSheetReader extends CommonAPI {
   ...
   // private static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("client_id.json"));
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in = GoogleSheetReader.class.getResourceAsStream("/client_id.json");

...
public class CommonAPI {
    ...
    public String browserstack_username= "mdenam1";
    public String browserstack_accesskey = "thdwTVvpacdqMxzHZYF1";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
                      @Optional("Windows") String os, @Optional("8") String os_version, @Optional("chrome") String browserName, @Optional("60")
    ...
    public WebDriver getLocalDriver(@Optional("OS X") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            if(OS.equalsIgnoreCase("OS X")){
                ...
                System.setProperty("webdriver.chrome.driver", "\\Users\\ENAM\\IdeaProjects\\WebAutomationFrameWorkEnam2018\\Generic\\browserDriver\\chromedriver.exe");
            }
